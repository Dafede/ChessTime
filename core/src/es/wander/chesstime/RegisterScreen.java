...
public class RegisterScreen implements Screen, InputProcessor, TextInputListener {
	...
	private String sendGet(String username, String password) throws Exception {
		...
		String url = "http://84.123.125.224/chesstime/register.php?username="+username+"&password="+password;
		String response="";
		URL obj = new URL(url);
